...
def obter_dados_gerais_de_todos_estudantes(query: Any, nome_do_curso: Any, nome_do_campus: Any, situacao_estudante: Any):
   """
      _summary_
   ...
   print(f"Tool `obter_dados_de_todos_estudantes` chamada com nome_do_curso={nome_do_curso}, nome_do_campus={nome_do_campus} e situacao_estudante={situacao_estudante}.")    
   query = str(query)
