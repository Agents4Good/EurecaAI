...
def get_todas_disciplinas_grade(nome_do_curso: Any, nome_do_campus: Any, curriculo: Any = "") -> list:
    ...
    print(f"Tool get_disciplinas_curso chamada com nome_do_campus={nome_do_campus} nome_do_curso={nome_do_curso} e curriculo={curriculo}.")
    
    dados_curso = get_curso_most_similar(nome_do_curso=nome_do_curso, nome_do_campus=nome_do_campus)
    print("Dados do curso", dados_curso)
    
    if (curriculo == ""):
        print("Entrou no if")
        dados_curriculo = get_curriculo_mais_recente_curso(nome_do_campus=nome_do_campus, nome_do_curso=nome_do_curso)
        curriculo = dados_curriculo["codigo_co_curriculo"]
...
def get_disciplina_curriculo(codigo_do_curso: Any, curriculo: Any, codigo_da_disciplina: Any) -> list:
    """
    Busca por todas as disciplinas da grade do curso de acordo com o curriculo.
