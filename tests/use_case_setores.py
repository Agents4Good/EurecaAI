...
question = "Some as bolsas de todos os estagiarios da UFCG no ano 2020 do campus Campina Grande do curso de engenharia civil?"
# question = "Traga os professores que foram orientadores de estágio do setor UNID. ACAD. DE CIÊNCIAS MÉDICAS do campus de campina grande no ano de 2024"
