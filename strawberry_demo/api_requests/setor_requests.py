...
def get_setores() -> list:
    ...
    """
    print(f"Chamada a API {base_url}/setores")
    params = {
        "campus": '1'
    }
...
def get_professores(codigo_do_setor: str) -> list:
    """
    Busca as informações de professores de um setor (centro).
    
    Args:
        base_url: URL base da API.
        codigo_do_setor: 'código_setor' (centro) do campus.
    ...
    params = {
        "status": "ATIVO",
        "setor": codigo_do_setor
    }

    print(f"Chamada a API {base_url}/professores com setor_centro {codigo_do_setor}")
...
def get_total_professores(codigo_do_setor: str) -> str:
    """
    ...
    """
    print(f"Chamada a API {base_url}/professores com setor_unidade={codigo_do_setor}")
    params = {
        "status": "ATIVO",
        "setor": codigo_do_setor
    }
...
def get_estagios(ano: str, setor_centro_unidade: str) -> list:
    ...
    print(f"Chamada a API {base_url}/estagios com inicio-de {ano} e fim-ate {ano}")
